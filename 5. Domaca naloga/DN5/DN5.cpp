...
int main() {
    ...
    std::cout << "Time of Gauss-Seide serijski: " << time_duration.count() << " seconds" << std::endl;
...
#pragma omp critical
    ...
    std::cout << "Time of Gauss-Seidel paralelni: " << time_duration_omp.count() << " seconds" << std::endl;
